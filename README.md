...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,064 | 🐛 100 | 📅 2026-06-30 list. Feel free to improve this list by [contributing](CONTRIBUTING.md)!
...
* [Go](https://github.com/dancannon/gorethink) ⭐ 1,648 | 🐛 27 | 🌐 Go | 📅 2025-10-24 - Go language driver for RethinkDB.
...
* [PHP](https://github.com/danielmewes/php-rql) ⭐ 337 | 🐛 35 | 🌐 PHP | 📅 2022-09-09 - A PHP client driver for the RethinkDB query language (ReQL).
